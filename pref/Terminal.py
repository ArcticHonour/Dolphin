...
##DO NO UNDER ANY CIRCUMSTANCES CHANGE THIS CODE UNLESS YOU KNOW WHAT YOU ARE DOING
##THIS CAN POTENTIALLY BREAK YOUR SETUP AND MEAN YOU MAY HAVE TO REINSTALL DOLPHIN!
## IF SOMETHIBNG LOOKS LIKE ITS NOT IMPORTANT ITS PROBABLY IMPORTANT
#####################################################################################
#8299db

help_text = """
                       Dolphin Console Help
----------------------------------------------------------------------------------------------------
...
class ConsoleApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Dolphin Terminal")
        ...
        # Output area
        self.output_area = scrolledtext.ScrolledText(self.frame, bg="black", fg="#4AF626", wrap=tk.WORD, height=15, font=("Courier", 20))
        ...
        self.update_output("Welcome to Dolphin Terminal\n")
